...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.markdown("<p style='text-align: center; color: #555; font-size: 11px; text-transform: uppercase; letter-spacing: 0.15em; margin-bottom: 8px;'>Powered by</p>", unsafe_allow_html=True)
        st.markdown(
            "<div class='stat-card' style='padding: 12px; margin-bottom: 8px;'>"
            "<div style='font-size: 18px; font-weight: 700; color: #93c5fd;'>OpenAI SDK</div>"
            "<div class='stat-label' style='margin-top: 4px;'>Responses API + Tool Calling</div>"
            "</div>",
            unsafe_allow_html=True,
        )
    ...
    st.markdown(
        ...
        <p style="color: #666; font-size: 14px; max-width: 600px; margin: 0 auto;">
            ...
            Built with an <strong style="color: #93c5fd;">OpenAI multi-agent runtime</strong> +
            <strong style="color: #c4b5fd;">Responses API tool calling</strong>.
    ...
    with tab_ingest:
        ...
        st.markdown("<p style='color: #666; font-size: 13px;'>Paste text or drop files in the <code>./inbox</code> folder. The <strong>IngestAgent</strong> handles extraction and memory writes through its own scoped tools.</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='color: #666; font-size: 13px;'>Upload images, audio, video, PDFs, or text files. "
                    "They'll be saved to <code>./inbox</code> and routed through the orchestrator automatically.</p>",
                    unsafe_allow_html=True)
        ...
        st.markdown("<p style='color: #666; font-size: 13px;'>The <strong>ConsolidateAgent</strong> runs automatically every 30 minutes and uses its own memory-store tools. Trigger it manually here.</p>", unsafe_allow_html=True)
    ...
    with tab_query:
        ...
        st.markdown("<p style='color: #666; font-size: 13px;'>The <strong>QueryAgent</strong> searches stored memories and synthesis history through its own scoped tools.</p>", unsafe_allow_html=True)
